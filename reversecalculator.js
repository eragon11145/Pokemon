...
hp1=(hp[i]);
  ...
  sdf1=(sdf[i]);
  spd1=(spd[i]);
  hp2= parseInt(document.getElementById("Health2").value)
  hp2-=parseInt(document.getElementById("Level").value)
  hp2-=10
  hp2*=100
  hp2=Math.ceil(hp2/parseInt(document.getElementById("Level").value))
  hp2-=(2*hp1)
...
atk2=Math.ceil(atk2)
atk2=Math.ceil(atk2-5)
atk2*=100
atk2=atk2/parseInt(document.getElementById("Level").value)
atk2=Math.ceil(atk2-Math.floor(.25*parseInt(document.getElementById("Attack1").value))-(2*atk1))
df2=(parseInt(document.getElementById("Defense2").value))
if ((document.getElementById("Nature").value==("Bold"))||(document.getElementById("Nature").value=="Impish")||(document.getElementById("Nature").value=="Lax")||(document.getElementById("Nature").value=="Relaxed")){
  df2=Math.ceil(df2/1.1)
}
if ((document.getElementById("Nature").value==("Lonely"))||(document.getElementById("Nature").value=="Mild")||(document.getElementById("Nature").value=="Hasty")||(document.getElementById("Nature").value=="Gentle")){
  df2=Math.ceil(df2/.9)
}
df2=Math.ceil(df2-5)
df2*=100
...
if ((document.getElementById("Nature").value==("Adamant"))||(document.getElementById("Nature").value=="Jolly")||(document.getElementById("Nature").value=="Impish")||(document.getElementById("Nature").value=="Careful")){
  spa2=Math.ceil(spa2/.9)
}
spa2=Math.ceil(spa2-5)
spa2*=100
spa2=spa2/parseInt(document.getElementById("Level").value)
spa2=Math.ceil(spa2-Math.floor(.25*parseInt(document.getElementById("SpecialAttack1").value))-(2*spa1))
sdf2=(parseInt(document.getElementById("SpecialDefense2").value))
if ((document.getElementById("Nature").value==("Calm"))||(document.getElementById("Nature").value=="Careful")||(document.getElementById("Nature").value=="Sassy")||(document.getElementById("Nature").value=="Gentle")){
  sdf2=Math.ceil(sdf2/1.1)
}
if ((document.getElementById("Nature").value==("Naughty"))||(document.getElementById("Nature").value=="Naive")||(document.getElementById("Nature").value=="Lax")||(document.getElementById("Nature").value=="Rash")){
  sdf2=Math.ceil(sdf2/.9)
}

sdf2=Math.ceil(sdf2-5)
sdf2*=100
sdf2=sdf2/parseInt(document.getElementById("Level").value)
sdf2=Math.ceil(sdf2-Math.floor(.25*parseInt(document.getElementById("SpecialDefense1").value))-(2*sdf1))
spd2=(parseInt(document.getElementById("Speed2").value))
if ((document.getElementById("Nature").value==("Timid"))||(document.getElementById("Nature").value=="Hasty")||(document.getElementById("Nature").value=="Jolly")||(document.getElementById("Nature").value=="Naive")){
  spd2=Math.ceil(spd2/1.1)
}
if ((document.getElementById("Nature").value==("Quiet"))||(document.getElementById("Nature").value=="Brave")||(document.getElementById("Nature").value=="Sassy")||(document.getElementById("Nature").value=="Relaxed")){
  spd2=Math.ceil(spd2/.9)
}

spd2=Math.ceil(spd2-5)
spd2*=100
spd2=spd2/parseInt(document.getElementById("Level").value)
spd2=Math.ceil(spd2-Math.floor(.25*parseInt(document.getElementById("Speed1").value))-(2*spd1))
  console.log('Gen'+ ' '+(gen));
  document.getElementById("Pokemon").innerHTML =pokemoN[i]
  document.getElementById("Health").innerHTML ='Base HP:'+ ' '+hp1
  document.getElementById("Attack").innerHTML ='Base Attack:'+' ' +atk1
  document.getElementById("Defense").innerHTML ='Base Defense:'+ ' '+df1
  document.getElementById("SpecialAttack").innerHTML ='Base Special Attack:' +' '+spa1
  document.getElementById("SpecialDefense").innerHTML ='Base Special Defense:'+' '+sdf1
  document.getElementById("Speed").innerHTML ='Base Speed:'+ ' '+spd1
   document.getElementById("Health3").innerHTML =' HP IV: ' + hp2
  document.getElementById("Attack3").innerHTML =' Attack IV: ' + atk2
  document.getElementById("Defense3").innerHTML =' Defense IV: ' + df2
  document.getElementById("SpecialAttack3").innerHTML =' Special Attack IV: ' + spa2
  document.getElementById("SpecialDefense3").innerHTML =' Special Defense IV: ' + sdf2
  document.getElementById("Speed3").innerHTML =' Speed IV: ' + spd2 
