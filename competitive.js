...
var x, y, pokemon, pokemoN, pokemoN2, hp, atk, df, spa, sdf, spd, p, i,gen, poke,hp1,atk1,df1,spa1,sdf1,spd1,gen2,poke2,time1,roundActive,total, highscore,data;
roundActive=false
//x=(Math.random())
//console.log(x)
//y=Math.random()
...
document.getElementById('Done').innerHTML='Congratulations! Your score was ' + total +'!'
        }
                                    }
                          ,1000);
}
